...
export default function IconicToolNav({
  ...
  const totalPages = Math.max(1, Math.ceil(displayedTools.length / PAGE_SIZE));
  ...
  const dockContent = (
    ...
    >
      ...
      <div className="relative" ref={popoverRef}>
        ...
        {/* Waffle / App Launcher Modal — Zero-Scrollbar Subject Matter Expert Architecture */}
        {launcherOpen && (
          <div
          ...
          >
            ...
            >
              ...
              <div className="flex items-center justify-between gap-3 pb-2.5 border-b border-border/70">
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <button
                    ...
                    className="px-2.5 py-1.5 rounded-xl text-[11px] font-semibold border border-border bg-page text-ink-2 hover:text-brand hover:border-brand/40 transition flex items-center gap-1.5"
                  >
              ...
              {/* Category Segmented Control (Alternative to Scrollbar #1) */}
              ...
              <div className="min-h-[190px] flex flex-col justify-between overflow-hidden">
                ...
                {/* Alternative to Scrollbar #2: Discrete Page Navigation Stepper */}
                {totalPages > 1 && (
