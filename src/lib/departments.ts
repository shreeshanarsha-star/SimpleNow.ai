...
export const DEPARTMENTS: Department[] = [
  ...
  },
  {
    ...
    tools: [
      ...
      { n: "Assessment.ai", s: "soon", group: "Talent Acquisition" },
      { n: "Offer.ai", s: "soon", group: "Talent Acquisition" },
...
export const PERSONAL_TOOLS: Department = {
  ...
  icon: "grid",
  status: "soon",
  desc: "Small, genuinely useful everyday tools — no AI key required, available to everyone regardless of department. Not built yet.",
  tools: [
    { n: "Calculator", s: "soon" },
    { n: "Quick Notes", s: "soon" },
    { n: "Calendar", s: "soon" },
    { n: "Clock", s: "soon" },
    { n: "Timer / Stopwatch", s: "soon" },
    { n: "To-Do List", s: "soon" },
    { n: "Unit Converter", s: "soon" },
  ],
};
