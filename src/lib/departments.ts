...
export const PERSONAL_TOOLS: Department = {
  ...
  tools: [
    ...
    { n: "To-Do List", s: "live", href: "/tools/todo", bundled: true },
    { n: "Calendar", s: "live", href: "/tools/calendar", bundled: true },
    { n: "Clock", s: "live", href: "/tools/clock", bundled: true },
    { n: "Timer / Stopwatch", s: "live", href: "/tools/timer", bundled: true },
    { n: "Unit Converter", s: "live", href: "/tools/converter", bundled: true },
    { n: "Jotz", s: "live", href: "/tools/jotz", bundled: true },
