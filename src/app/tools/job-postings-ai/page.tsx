...
export default function JobPostingsAiPage() {
  ...
  if (step === "done") {
    return (
      <AppShell title="Job Postings.ai">
        <div className="flex-1 flex flex-col items-center justify-center text-center gap-3">
          <div className="w-11 h-11 rounded-full bg-good-wash text-good-text flex items-center justify-center">
            <Icon name="check" className="w-5 h-5" />
          </div>
          <h2 className="m-0 text-[18px] font-bold">Sent for your approval</h2>
          <p className="m-0 text-[13px] text-ink-muted max-w-sm">
            This posting is waiting in the Admin approval queue — nothing goes
            live until you approve it there.
          </p>
    ...
    <AppShell title="Job Postings.ai">
      <div className="max-w-2xl">
        <p className="text-[13px] text-ink-2 mb-5">
          Draft a role, let AI polish the description, then submit it — it
          goes to your Admin approval queue before it&rsquo;s published.
        </p>
