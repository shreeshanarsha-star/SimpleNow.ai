...
import SmartScreenAiForm from "@/components/tools/SmartScreenAiForm";

const FEATURE_KEY = "Smart Screen.ai";

export default async function SmartScreenAiPage() {
  ...
  if (!user) {
    return (
      <AppShell title="Smart Screen.ai">
  ...
  return (
    <AppShell title="Smart Screen.ai">
      {hasAccess ? (
        ...
        <AccessDenied reason='The admin hasn’t granted you access to "Smart Screen.ai" yet.' />
      )}
    </AppShell>
  );
}
